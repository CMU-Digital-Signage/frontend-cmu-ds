...
<template>
  ...
  >
    ...
    <!-- "calendar dashboard"-->
    <ul
      v-else-if="$route.path === '/' || $route.path === '/search-content'"
    ...
    <!-- "Content Manage" -->
    <ul v-else-if="$route.path === '/content'" class="justify-between">
    ...
    <!-- Preview -->
    <ul
      v-else-if="$route.path.includes('/preview') && devicePreview"
    ...
    <!-- "Device" -->
    <ul v-else-if="$route.path === '/deviceManage'">
    ...
    <!-- "Emergency" -->
    <ul v-else-if="$route.path === '/emergency'">
    ...
    <!-- "Glance Bar Management" -->
    <ul v-else-if="$route.path === '/glanceBarManage'">
      <label class="font-semibold">Glance Bar</label>
    </ul>
  </div>
</template>
